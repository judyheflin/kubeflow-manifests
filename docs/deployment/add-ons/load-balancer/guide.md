...
1. Goto Route53 and create a subdomain to host Kubeflow:
    ...
    1. Copy the value of NS type record from the subdomain hosted zone (`platform.example.com`)
        1. ![subdomain-NS](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/subdomain-NS.png)
    1. Create an `NS` type of record in the root `example.com` hosted zone for the subdomain `platform.example.com`.
        1. ![root-domain-NS-creating-NS](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/root-domain-NS-creating-NS.png)
        1.  The following image is a screenshot of the record after creation in `example.com` hosted zone.
            1. ![root-domain-NS-created](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/root-domain-NS-created.png)
...
![successfully-issued-certificate](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/successfully-issued-certificate.png)
...
![DNS-record-for-certificate-validation](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/DNS-record-for-certificate-validation.png)    
...
1. When ALB is ready, copy the DNS name of that load balancer and create a CNAME entry to it in Route53 under subdomain (`platform.example.com`) for `*.platform.example.com`
    1. ![subdomain-*.platform-record](https://raw.githubusercontent.com/awslabs/kubeflow-manifests/main/docs/deployment/add-ons/load-balancer/files/subdomain-*.platform-record.png)
